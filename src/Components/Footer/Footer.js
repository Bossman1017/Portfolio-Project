...
const Footer = () => {
    return (
        <div>
            ...
            <a href="https://github.com/Bossman1017/Portfolio-Project" target="_blank" rel="noopener noreferrer">   <img className = "github_footer" src = "img/github.jpg"></img></a>
            <img className = "html_footer" src = "img/html.jpg"></img>  
            <img className = "css_footer" src = "img/css.jpg"></img>  
            <img className = "js_footer" src = "img/js.png"></img>  
            <img className = "react_footer" src = "img/react1.png"></img>  
